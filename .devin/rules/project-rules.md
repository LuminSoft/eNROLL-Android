...
- [ ] **Azure task breakdown**: Add taks for every change with time and all things azure task need and taks is less than 2 hours just add one task and dont break it 

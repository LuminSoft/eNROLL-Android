...
fun EnrollItemView(  images: List<Int>,textResourceId: Int) {
    EnrollItemView(images = images, textResourceId = textResourceId, customStepIcon = null)
}

@Composable
fun EnrollItemView(images: List<Int>, textResourceId: Int, customStepIcon: StepIcon?) {
    ...
    Column(
        ...
        ResolvedStepIcon(
            customIcon = customStepIcon,
            modifier = iconModifier,
            contentScale = ContentScale.Fit,
            defaultContent = {
                ImagesBox(images = images, modifier = iconModifier)
            }
        )
        Spacer(modifier = Modifier.height(80.dp))
        Text(

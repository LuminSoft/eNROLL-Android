...
import com.luminsoft.enroll_sdk.features_sign_contract.low_risk_fra.low_risk_fra.view_model.LowRiskFRAViewModel
...
@Composable
fun PhoneLowRiskFRAScreenContent(
    signContractViewModel: SignContractViewModel,
    navController: NavController,
) {

    val validateOtpLowRiskFRAUseCase =
        ValidateOtpLowRiskFRAUseCase(koinInject())
    val lowRiskFRASendOTPUseCase =
        LowRiskFRASendOTPUseCase(koinInject())

    val phoneViewModel =
        remember {
            LowRiskFRAViewModel(
                lowRiskFRASendOTPUseCase = lowRiskFRASendOTPUseCase,
                validateOtpLowRiskFRAUseCase = validateOtpLowRiskFRAUseCase
            )
        }

...
interface NationalIdConfirmationApi {
    @POST("api/v2/onboarding/NationalId/UploadFrontImage")
    ...
    @POST("api/v2/onboarding/NationalId/ApproveFrontImage")
    suspend fun nationalIdApproveFront(@Body request: PersonalConfirmationApproveRequest): Response<String>

    @POST("api/v2/onboarding/NationalId/UploadBackImage")
    ...
    @POST("api/v2/onboarding/NationalId/ApproveBackImage")

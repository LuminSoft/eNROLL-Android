...
fun MailAuthScreenContent(
    mailViewModel: MailAuthViewModel,
        ...
        if (loading.value) LoadingView()
            ...
            Column(
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    Text(
                        mailViewModel.mailValue.value!!.text,
                        fontSize = 10.sp,
                ...
                if (mailViewModel.isNotFirstMail.value && ticks == 0)
                    Text(
                ...
                ButtonView(
                    ...
                    onClick = {
                        mailViewModel.mailValue.value = TextFieldValue()
                        mailsOnBoardingVM.callValidateOtp(otpValue.value)
                    },
                    title = stringResource(id = R.string.confirmAndContinue)
                )
                Spacer(modifier = Modifier.height(20.dp))
                if (!mailViewModel.isNotFirstMail.value)
                    ButtonView(
                        isEnabled = ticks == 0,
                        onClick = {
                            mailsOnBoardingVM.callSendOtp()

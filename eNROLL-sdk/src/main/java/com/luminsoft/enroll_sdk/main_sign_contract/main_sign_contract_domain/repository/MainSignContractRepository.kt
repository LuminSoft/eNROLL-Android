...
interface MainSignContractRepository {
    ...
    suspend fun getSignContractSteps(): Either<SdkFailure, StepSignContractModel>
    suspend fun getSignContractFiles(): Either<SdkFailure, List<SignContractFileItemModel>>
}
...
object EncryptDecrypt {
    ...
    private const val ENCRYPTION_KEY = "4D9f6H8k2L3p0Z1a" // AES encryption key (must be 16, 24, or 32 bytes for AES)

    /**
     * Convert Bitmap to Base64 encoded string.
     *
     * @param bitmap The Bitmap to be converted.
     * @return Base64 encoded string representing the Bitmap.
     */
    fun bitmapToBase64(bitmap: Bitmap): String {
        val byteArrayOutputStream = ByteArrayOutputStream()
        bitmap.compress(Bitmap.CompressFormat.PNG, 100, byteArrayOutputStream) // You can use JPEG or PNG format

package com.luminsoft.enroll_sdk.main.main_presentation.main_auth.view_model
    ...
    MainViewModel
{
    ...
    private fun generateToken() {
        ...
        ui {
            ...
            params.value = GenerateOnboardingSessionTokenUsecaseParams(EnrollSDK.tenantId,EnrollSDK.tenantSecret , udid)

...
const val nationalIdOnBoardingFrontConfirmationScreen = "nationalIdOnBoardingFrontConfirmationScreen"
...
fun NavGraphBuilder.nationalIdRouter(navController: NavController, onBoardingViewModel: OnBoardingViewModel) {

    composable(route = nationalIdOnBoardingPrescanScreen) {
        NationalIdOnBoardingPrescanScreen(navController=navController, onBoardingViewModel =onBoardingViewModel)
    }
    composable(route = nationalIdOnBoardingFrontConfirmationScreen) {
        NationalIdOnBoardingFrontConfirmationScreen(navController=navController, onBoardingViewModel =onBoardingViewModel)
    }
}
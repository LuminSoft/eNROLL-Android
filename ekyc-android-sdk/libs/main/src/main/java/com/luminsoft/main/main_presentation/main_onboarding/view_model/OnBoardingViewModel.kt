package com.luminsoft.main.main_presentation.main_onboarding.view_model
...
class OnBoardingViewModel(private val getSavedCardsUseCase: GetSavedCardsUseCase) :
    ViewModel() {
//

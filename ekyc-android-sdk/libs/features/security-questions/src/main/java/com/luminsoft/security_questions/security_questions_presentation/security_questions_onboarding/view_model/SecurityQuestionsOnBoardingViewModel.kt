package com.luminsoft.security_questions.security_questions_presentation.security_questions_onboarding.view_model
...
class SecurityQuestionsOnBoardingViewModel(private val getSavedCardsUseCase: GetSavedCardsUseCase) :
    ViewModel() {

package com.luminsoft.national_id_confirmation.national_id_confirmation_presentation.national_id_onboarding.view_model
...
class NationalIdFrontOcrViewModel(/*private val payUseCase: PayUseCase, private val getFees: GetFeesUseCase*/) :
    ViewModel() {
